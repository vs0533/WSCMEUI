 ...
 */
Ext.define('WsCme.lib.ToggleSlide', {
...
//                'change');
    ...
    onRender: function()
    {
        ...
        {
            app.lib.ToggleSlide.superclass.disable.call(me);
        }
    },
    ...
    enable: function()
    {
        if(this.disabled)
        {
            app.lib.ToggleSlide.superclass.enable.call(this);
    ...
    disable: function()
    {
        if(!this.disabled)
        {
            app.lib.ToggleSlide.superclass.disable.call(this);
