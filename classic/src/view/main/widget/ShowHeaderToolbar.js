 ...
 *
 */
Ext.define('WsCme.view.main.widget.ShowHeaderToolbar', {
    ...
    toggle : function() {
        console.log((this.state == 'up' ? 'hide' : 'show') + ' top and bottom region');
        this.execute();
        if (this.state == 'up')
            this.state = 'down';
        else
    ...
    refreshState : function() {
        ...
        a.dom.className = 'fa fa-angle-double-'+this.state+ ' fa-lg regionchange"></span>';
